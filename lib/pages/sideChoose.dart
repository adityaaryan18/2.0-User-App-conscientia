...
class Sidechoose extends StatefulWidget {
  const Sidechoose({Key? key}) : super(key: key);

  @override
  State<Sidechoose> createState() => _DashboardPageState();
}


class _DashboardPageState extends State<Sidechoose> {
  @override
  void initState() {
    super.initState();

...
class _EmailPasswordSignupState extends State<EmailPasswordSignup> {
  ...
  void verifyOtp() {
    if (otpController.text == generatedOtp) {
      setState(() {
        isOtpVerified = true;
        usernameController.text = generatedUsername; // Simulate username from API
      });
    } else {
      showPopUpCard(
        context,
 ...
 void signUpUser() async {
  if (passwordController.text.isEmpty) {
    ...
    try {
      UserCredential userCredential = await FirebaseAuthMethods(FirebaseAuth.instance).signUpWithEmail(
  ...
  void showPopUpCard(BuildContext context, String message, VoidCallback onPressed) {
    showDialog(
      context: context,

...
class _VerifyDetailsPageState extends State<VerifyDetailsPage> {
  ...
  Future<bool> _verifyRegistration() async {
    ...
    try {
      print('Got VerifyXyz ${requestBody}');
      ...
      print('Got VerifyXX ${res.statusCode.toString()}');
      print('Got VerifyXX ${res.body.toString()}');
  ...
  Future<void>_sendPaymentDataToBackend(PaymentSuccessResponse response) async {
    print("object");
       print('XXXY ${response.paymentId }');
       print('XXXY ${response.orderId}');
       print('XXXY ${response.signature}');
       print('XXXY ${widget.teamName}');
       print('XXXY ${widget.eventDetails['_id']  }');
       print('XXXY ${widget.eventType}');
       print('XXXY ${widget.teamMembers}');
       print('XXXY ${widget.teamLeader['_id']}');
       print('XXXY ${ _referralController.text}');
    ...
    try {
      print('ANKIT XX$_referralController.text.toString()');
      final res = await http.post(
        Uri.parse(
